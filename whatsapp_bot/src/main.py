...
import os
# Importa la función ask_question en lugar de chat_completion
from whatsapp_bot.helper.openai_api import ask_question
...
def twilio():
    try:
        ...
        # Si hay query, la procesamos con ask_question
        if query:
