...
# testing_function("¿Cuántas sedes y centros de inspección tiene Kavak en México?")
# testing_function("¿Qué estatus ha logrado Kavak en México?")
# testing_function("¿Cuál es el horario de atención de Kavak?")
# testing_function("¿Dónde se encuentra Kavak en Puebla?")
# testing_function("¿Qué beneficios ofrece Kavak al comprar un auto seminuevo?")
# testing_function("¿Cómo funciona el proceso de certificación de autos en Kavak?")
# testing_function("¿Qué opciones de pago ofrece Kavak si quiero vender mi auto?")
# testing_function("¿Qué documentación necesito para solicitar un plan de pago?")
# testing_function("¿Cómo puedo realizar el proceso de compra sin salir de casa?")
# testing_function("¿Qué garantía ofrece Kavak para los autos que vende?")
# testing_function("¿Qué servicios están disponibles en la App Kavak?")
# testing_function("¿Dónde se encuentran las sedes de Kavak en Monterrey?")
# testing_function("¿Cómo se realiza la inspección inicial de un auto usado en Kavak?")
# testing_function("¿Qué opciones tengo si el auto que quiero no está en el catálogo de Kavak?")
# testing_function("¿Dónde está ubicada la sede de Kavak en Querétaro?")
# testing_function("¿Qué experiencia ofrece Kavak postventa?")
# testing_function("¿Cómo puedo asegurar mi compra con Kavak?")
# testing_function("¿Qué opciones ofrece Kavak para ampliar la garantía del auto?")
# testing_function("¿Dónde se encuentra la sede de Kavak en Guadalajara?")
